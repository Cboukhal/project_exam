...
<body>
    ...
    <main>
        <!-- HERO SECTION -->
        <section class="hero" aria-label="Bannière liens et partenaires">
            <div id="slider" role="region" aria-label="Carrousel d'images">
                <img src="./asset/image/ampoule.jpg" alt="Réseau de partenaires professionnels électricité">
                <img src="./asset/image/ampoule2.jpg" alt="Certifications et qualifications électriques">
                <img src="./asset/image/ampoule3.jpg" alt="Organismes professionnels du secteur électrique">
            </div>

            <div class="hero-overlay">
                <h1>Liens et Partenaires</h1>
